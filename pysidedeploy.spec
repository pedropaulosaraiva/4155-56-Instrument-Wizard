...
# application icon (relative to the directory pyside6-deploy is run from,
# i.e. the project root)
icon = assets\branding\logo.ico
...
extra_args = --quiet --noinclude-qt-translations --assume-yes-for-downloads --windows-console-mode=disable --include-package=pyqtgraph --include-package-data=pyqtgraph --include-package=pyvisa --output-filename=wizard_4155_4156.exe
